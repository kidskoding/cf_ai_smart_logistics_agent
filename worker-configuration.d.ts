/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be7dd042730a8dd9f7421701ae8fd5bc)
// Runtime types generated with workerd@1.20251217.0 2025-04-24 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "ChatAgent" | "AppController";
	}
	interface Env {
		CF_AI_BASE_URL: "https://gateway.ai.cloudflare.com/v1/YOUR_ACCOUNT_ID/YOUR_GATEWAY_ID/openai";
		CF_AI_API_KEY: "your-cloudflare-api-key";
		CHAT_AGENT: DurableObjectNamespace<import("./worker/index").ChatAgent>;
		APP_CONTROLLER: DurableObjectNamespace<import("./worker/index").AppController>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_AI_BASE_URL" | "CF_AI_API_KEY">> {}
}
